...
const groups: Record<string, string[]> = {
  ...
  'Scan guardrails': ['default_check_period', 'default_refresh_period', 'max_source_pages', 'max_action_pages_per_post', 'max_mention_pages', 'max_reply_search_pages', 'daily_scored_action_cap', 'low_activity_threshold', 'skip_protected_members', 'protected_role_names'],
